const questions = [
    ...
    },
    {
        type: "exercicis",
        category: "maquines",
        text: `Un volant amb un moment d’inèrcia al voltant del seu eix I = 0,9 kg · m² gira a n₀ = 5 000 min⁻¹ gràcies a l’acció d’un motor. Es desconnecta el motor i s’observa que el volant triga t = 1 min a quedar-se en repòs a causa d’un parell de fricció que se suposa constant.
        <br>Determineu:
        <br><br><strong>a)</strong> L’acceleració angular del volant α. [0,5 punts]
        <br><strong>b)</strong> El nombre de voltes n que farà el volant abans d’aturar-se. [1 punt]
        <br><strong>c)</strong> L’energia mecànica dissipada en aquest procés Ediss. [1 punt]`,
        correctAnswer: "",
        steps: `
        <strong>Resolució pas a pas:</strong>
        <br><br>
        <strong>a) Acceleració angular $\alpha$:</strong>
        <br>Primer convertim la velocitat inicial a rad/s i el temps a segons:
        \\[
        \omega_0 = 5000 \\cdot \\frac{2\pi}{60} = 523,60 \\, \\text{rad/s} \\, ; \\quad t = 60 \\, \\text{s}
        \\]
        \\[
        ...
        <strong>b) Nombre de voltes $n$:</strong>
        <br>Calculem primer l'angle total recorregut $\theta$:
        \\[
        \theta = \omega_0 \\cdot t + \\frac{1}{2} \\alpha \\cdot t^2 = 523,60 \\cdot 60 + \\frac{1}{2} (-8,727) \\cdot 60^2 = 15708 \\, \\text{rad}
        \\]
        \\[
        ...
        <strong>c) Energia mecànica dissipada $E_{\text{diss}}$:</strong>
        <br>L'energia dissipada coincideix amb l'energia cinètica inicial, ja que el volant s'atura completament:
        \\[
        E_{\text{diss}} = \\Delta E_c = \\frac{1}{2} I \\cdot \omega_0^2 = \\frac{1}{2} \\cdot 0,9 \\cdot 523,60^2 = 123414 \\, \\text{J} = 123,41 \\, \\text{kJ}
        \\]`
    },
];
